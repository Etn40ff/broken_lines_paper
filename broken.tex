...
\begin{theorem}
\cite{LS,Rup}\sayGM{Does this look better to you? (Gregg)}\sayDR{Not really, I only wanted to let people know why I added the extra reference, I don't think it needs to be in the paper.} Each cluster variable of $\cA(b,c)$ is positive.
\end{theorem}
