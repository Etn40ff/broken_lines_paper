...
\address[Dylan Rupel]{Northeastern University}
\email{drupel@nd.edu}
...
\sayDR{Yes, they agree.  Both have multiples of $b$ in the exponent of $x_1$ and multiples of $c$ in the exponent of $x_2$.  As long as the exchange matrix is not explicitly mentioned we should not have to worry about it.}
...
\sayDR{I opted for Northeastern since most of the work was done while I was employed by them.  Hmm, Notre Dame is employing me now though, is there a reasonable way to put both?}
