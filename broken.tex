...
walls of $\fD_{(b,c)}\smallsetminus\fD_{\mathrm{in},(b,c)}$ to the third quadrant \sayDR{It seems like a little more details are needed here, we also need to refer to this in the proof of Prop. 4.4 so it might be good to state as a lemma.}. 
