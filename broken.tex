...
\[ \{m\in M \mid c_m\neq 0\} \]
and the \emph{Newton polygon} of $f$ is the convex hull in $M\otimes\mathbb{R}$ of the support of $f$.\sayGM{ISSUE: Newton polygons are inherently convex; but the region in Figure 1.6b is not.  We may need to replace "Newton polygon" with some terminology which allows a \emph{choice} of polygon containing the support.}
