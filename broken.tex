...
\[
  \fp_{\gamma, \fD} := \lim_{k \rightarrow \infty} \fp ^k_{\gamma, \fD}. 
...
\sayDR{The next two paragraphs seem to be quoting a non-trivial result, we should probably give a reference. [Mandy: ref add]} Now consider the two linear involutions $S_1$ and $S_2$ given by
\[
  S_1 =  
  \begin{pmatrix}
    -1 & -b \\
