...
the \emph{pointed support} of $x[a_1,a_2]$.  \Cref{th:greedy} is proven using the following characterization of the greedy elements by their pointed supports.

\sayGM{*** We need to define Newton polygon and support here. (gregg)}

\begin{theorem}\label{th:Newton polygons}(\cite[Proposition~4.1]{LLZ} and \cite[Corollary 3.5]{LLZ2})
...
\begin{figure}[h!]
  ...
  \begin{tikzpicture}[scale=.7]
    ...
    \end{scope}
  \end{tikzpicture}
  \caption{The Newton polygon of $x[a_1,a_2]$.} 
