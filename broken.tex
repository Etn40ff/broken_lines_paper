...
The proof will be to show that $\Theta_{m}^{\mathbf{d}}$ is a pointed element with the same Newton polytope as $x[-m_1,-m_2]$.  By Theorem \ref{th:pointed supports}, this is already enough to show that $\Theta_{m}^\mathbf{d}=x[-m_1,-m_2]$.
