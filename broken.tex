...
applying Theorem \ref{th:KS} to $\fD_{\mathrm{in},(b,c)}$.
...
\begin{figure}
  ...
  \end{tikzpicture}
  \caption{The scattering diagram $\fD_{(2,1)}$.  Since
  \[
    \fD_{\mathrm{in},(2,1)} =  
    \left\{ 
      \big(\RR (-1,0), 1+x_1^{-2}\big), 
  ...
  the two walls $\RR_{\leq 0} (-1,1), 1+x_1^{-2}x_2^2 \big)$ and $\big( \RR_{\leq 0} (-2,1), 1+x_1^{-2}x_2 \big)$.
  %\[ 
  %  \big( \RR_{\leq 0} (-1,1), 1+x_1^{-2}x_2^2 \big)
  %  \quad \mbox{and} \quad
  %  \big( \RR_{\leq 0} (-2,1), 1+x_1^{-2}x_2 \big).
