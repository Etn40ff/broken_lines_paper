...
\saySS{Shortened last sentence; remove this comment whenever you want.}
...
\begin{remark} 
  ...
  $\bfg$-vector of this cluster monomial is precisely $m$. We again refer to
  \cite{FZ4} for the definitions and basic properties of \emph{$\bfg$-vectors}.
\end{remark}
...
The set
\saySS{Changed the notation here to be consistent with the line just above.
  Remove this comment whenever you want.}
\[
  T(\fD_{(b,c)}):=
