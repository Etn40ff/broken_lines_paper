...
\]\sayDR{Does this limit always exist?}\sayMC{that is why we work in formal power series ring!}
\begin{defn}
...
\begin{theorem} 
  ...
  $\ZZ[[x_1^{-1},x_2]]$ localized at $x_1^{-1}x_2$ \sayDR{This claim is not addressed in the proof below, however it does not seem obvious since the functions attached to the walls in the imaginary cone really are power series in $x_1^{-1}$ and $x_2$.}\sayMC{:P typo fixed}.  If for any path $\gamma$ in
