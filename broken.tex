...
\begin{proof}
  (1) is a main result of \cite{CPS}, quoted in this context in \cite[Theorem~3.5]{GHKK}.  The second statement is \cite[Example~7.18]{GHKK} where $\Theta$ is taken to be the subset of $M$ consisting of those $m$ for which
  $\Theta_{q,m}$ is a Laurent polynomial for some $q$ in the interior of a chamber of $\fD$ (and hence by \cite[Proposition~7.1]{GHKK}, all 
  chambers).
  Next, (3) follows from (2) by Theorem \ref{univLaurent}. 
  Finally, (4) follows from \cite[Proposition~3.8]{GHKK} using the argument of
  \cite[Theorem~4.8]{GHKK} in the case that the chamber is not the positive
  quadrant.
\end{proof}
...
\begin{remark} 
  ...
  the first quadrant, then from (1) and (4) above we see that
...
\begin{example}
  ...
  for the basis elements with $\bfg$-vectors $(d,-d)$ for $d>0$. The
