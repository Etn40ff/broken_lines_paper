...
\begin{theorem}
\cite[for $b=c$]{LS}, \cite[for $b\neq c$]{Rup} Each cluster variable of $\cA(b,c)$ is positive.
\end{theorem}
...
\]
%\sayDR{The $k$ here looks like an exponent, does anyone oppose moving it to a subscript?}\sayGM{I think the subscript is already too crowded.  How do like parenthetical exponents instead? (Gregg)} 
Then we define
\[
