...
The organization of the paper is as follows.  In sections 2 and 3 we review the basic definitions and properties of the greedy and theta bases, respectively.  The natural parametrizing sets of the two bases, the \sayDR{boldface letters?} $d$-vectors and $g$-vectors, are distinct, and in section 4 we explain how to relate them.  This determines a bijection between the two bases, and in section 5 we show that the basis elements mapped to each other by this bijection actually coincide, proving the main theorem.
...
Fix $b,c>0$ and consider rational functions $x_k\in\QQ(x_1,x_2)$, for $k\in\ZZ$,
...
\begin{theorem}\label{th:Laurent}\cite[Theorem~3.1]{FZ} 
  For any $j,k\in\ZZ$ we have $x_j\in\ZZ[x_k^{\pm1},x_{k+1}^{\pm1}]$.
\end{theorem}
...
\begin{proof}
  ...
  \begin{itemize}
    \item If $(a'_1,a'_2)$ lies on or North of the line segment $OB$, i.e. $a_1a'_2\le a'_1a_2$, then we consider the point $C'=(-a'_1,-a'_2+ca'_2)$ at the Northern boundary of the Newton polytope of $x[a'_1,a'_2]$ and compare with the line segment $OC$.  In this case, we have
    \[-a_1(-a'_2+ca'_1)=a_1a'_2-ca_1a'_1\le a'_1a_2-ca_1a'_1=-a'_1(-a_2+ca_1)\]
    and thus $C'$ lies on or North of $OC$.  If $C'$ is North of $OC$ or $C'\ne C$ is on $OC$, then it lies outside the Newton polytope of $z$ which is impossible.  Thus we must have $C'=C$, but this implies $(a'_1,a'_2)=(a_1,a_2)$ which is clearly false.
    \item If $(a'_1,a'_2)$ lies on or East of the line segment $OB$, i.e. $a'_1a_2\le a_1a'_2$, then we consider the point $A'=(-a'_1+ba'_2,-a'_2)$ at the Eastern boundary of the Newton polytope of $x[a'_1,a'_2]$ and compare with the line segment $OA$.  In this case, we have
